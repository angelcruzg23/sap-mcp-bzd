...
- **Message type mapping**: FM Z custom puede mapear incorrectamente → process mode incorrecto → CRM_ORDER_MAINTAIN falla.
...
- Lógica condicional: solo actuar cuando el valor específico viene de TMS.
