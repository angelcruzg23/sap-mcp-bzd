...
|------------|---------|-----|
| Kiro IDE | Actual | IDE principal con MCP SAP |
| MCP Server SAP | server.py (16 tools) | Conexión ADT REST API |
| Eclipse ADT | Actual | Operaciones que MCP no soporta |
| SAP GUI | Actual | Transacciones de config (STVARV, SE09, SWPR, CT04) |
...
### POCs y utilidades ($TMP)
| Objeto | Tipo | Descripción |
|--------|------|-------------|
| ZDUMP_CONTEXT_4_CLAUDE | Programa | Generador de contexto MD |
| ZDUMP_CONTEXT_TEST | Programa | Versión test sin GUI_DOWNLOAD |
| ZKIROPRUEBA | Programa | Hello world de prueba |
| ZR_SD_JOB_CHAIN_POC | Programa | POC de job chaining |

---

## Programas del workspace local

| Carpeta | Contenido | Estado |
|---------|-----------|--------|
| ConsultaStockMaterial/ | Stock por planta SOLID + tests + API spec | ✅ Completo |
| ZR_SD_QUICK_ORDERS/ | Report pedidos rápidos OO + tests | ✅ Completo |
| ZSD_QUOTATION_SALSFRC_CREATE/ | Creación quotations desde Salesforce (SOLID) | ✅ Completo |
| L2C_CHG0436393/ | Fix enqueue PPD workflow | ✅ Desplegado |
| ConestogaChange/ | Equipment type US Bank | ✅ Documentado |
| ZSDR_DAILY_INVOICE_REPORT/ | Bug SCOMNO EHP8 | ✅ Analizado |
| ZSDR_ANOKA_REPORT_BAK_N/ | Authority check fix | ✅ Analizado |
| FlujoDatosECC_CRM/ | Análisis flujo middleware | 🔄 En progreso |
| Incidente/ | Arithmetic error clasificación | ✅ Analizado |
| ATP_JuanDa/ | Análisis ATP | 📋 Documentado |
| ZR_SD_JOB_CHAIN_POC/ | POC job chaining | ✅ POC |
| BlockchainLearning_v1/ | Blockchain learning app | ✅ Side project |
| QueHayMetro/ | App metro Medellín | 🔄 En progreso |
